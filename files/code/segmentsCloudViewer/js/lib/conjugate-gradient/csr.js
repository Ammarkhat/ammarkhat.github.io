...
var CSRMatrixContainer = {};
CSRMatrixContainer.fromList = fromList;
CSRMatrixContainer.fromDictionary = fromDictionary;
CSRMatrixContainer.fromDense = fromDense;
CSRMatrixContainer.fromNDArray = fromNDArray;
...
proto.get = function(i,j) {
  ...
  var i0 = bsearch(this.rows, i)
  if(i0 < 0 || this.rows[i0] !== i) {
    return 0
  }
  var c_start = this.row_ptrs[i0]
    , c_end = this.row_ptrs[i0+1]
    , j0 = bsearch(this.columns, j, undefined, c_start, c_end-1)
  if(j0 < c_start) {
    return 0
  }
